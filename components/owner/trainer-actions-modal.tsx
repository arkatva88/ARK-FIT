...
export function TrainerActionsModal({ trainer }: TrainerActionsModalProps) {
  ...
  const handleToggleActive = async () => {
    ...
    try {
      ...
      alert("Failed to toggle coach active status: " + err.message);
    } finally {
    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm animate-in fade-in duration-150">
          <div className="w-full max-w-md rounded-xl border border-slate-200 bg-white p-6 shadow-2xl relative max-h-[90vh] overflow-y-auto">
            <button
