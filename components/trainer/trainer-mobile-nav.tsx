...
export function TrainerMobileNav({ gymName = "ARK FIT" }: TrainerMobileNavProps) {
  ...
  const moreItems = [
    { label: "Nutrition & Diet", href: "/trainer/diet", icon: Salad, desc: "Prescribe caloric & macro splits" },
    { label: "Progress Logs", href: "/trainer/progress", icon: TrendingUp, desc: "Scale weight & PR tracking" },
    { label: "Floor Notes", href: "/trainer/notes", icon: FileText, desc: "Athlete form & injury records" },
  ];
